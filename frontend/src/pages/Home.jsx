...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      <div className="bg-gradient-to-r from-ampersound-red to-ampersound-red text-white py-20">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl font-bold mb-4">Ampersound Catalog Intelligence</h1>
          <p className="text-xl mb-8">Music Publishing Analytics & Valuation Platform</p>
          <Link
            to="/login"
            className="bg-white text-ampersound-red px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 inline-block"
          >
            Get Started
          </Link>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              <div className="bg-ampersound-red text-white rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 text-2xl font-bold">
                1
              </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 text-center">
            ...
            <button
              ...
              className="bg-ampersound-red text-white px-8 py-3 rounded-lg font-semibold hover:bg-opacity-90"
            >
              Download Template
            </button>
          </div>
