          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <FadeIn>
              <div className="bg-white/80 backdrop-blur-sm rounded-[20px] p-6 border border-[rgba(59,77,67,0.06)] h-full">
                <h3 className="text-[17px] font-semibold text-[#3D4A44] mb-3">Music catalog management, end to end</h3>
            ...
            <FadeIn delay={80}>
              <div className="bg-white/80 backdrop-blur-sm rounded-[20px] p-6 border border-[rgba(59,77,67,0.06)] h-full">
                <h3 className="text-[17px] font-semibold text-[#3D4A44] mb-3">Defensible catalog valuation</h3>
                <p className="text-[14px] text-[#7A8580] leading-relaxed">
            ...
            <FadeIn delay={160}>
              <div className="bg-white/80 backdrop-blur-sm rounded-[20px] p-6 border border-[rgba(59,77,67,0.06)] h-full">
                <h3 className="text-[17px] font-semibold text-[#3D4A44] mb-3">Royalty processing without the spreadsheets</h3>
                <p className="text-[14px] text-[#7A8580] leading-relaxed">
            ...
            <FadeIn delay={240}>
              <div className="bg-white/80 backdrop-blur-sm rounded-[20px] p-6 border border-[rgba(59,77,67,0.06)] h-full">
                <h3 className="text-[17px] font-semibold text-[#3D4A44] mb-3">Rights administration and contract intelligence</h3>
                <p className="text-[14px] text-[#7A8580] leading-relaxed">
            ...
            <FadeIn delay={320}>
              <div className="bg-white/80 backdrop-blur-sm rounded-[20px] p-6 border border-[rgba(59,77,67,0.06)] h-full">
                <h3 className="text-[17px] font-semibold text-[#3D4A44] mb-3">Sync placements and creator portals</h3>
                <p className="text-[14px] text-[#7A8580] leading-relaxed">
            ...
            <FadeIn delay={400}>
              <div className="bg-white/80 backdrop-blur-sm rounded-[20px] p-6 border border-[rgba(59,77,67,0.06)] h-full">
                <h3 className="text-[17px] font-semibold text-[#3D4A44] mb-3">Streaming intelligence and chart data</h3>
                <p className="text-[14px] text-[#7A8580] leading-relaxed">
