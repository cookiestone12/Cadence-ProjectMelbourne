...
export default function NotificationBell() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="fixed left-4 right-4 bottom-20 sm:absolute sm:left-auto sm:right-0 sm:bottom-auto sm:mt-2 sm:w-80 max-w-[calc(100vw-2rem)] sm:max-w-none bg-white rounded-xl shadow-lg border border-[rgba(59,77,67,0.08)] z-50 overflow-hidden">
