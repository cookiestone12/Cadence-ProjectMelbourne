...
# Note: a true route-level (FastAPI TestClient) test for the spec'd
# org catalog endpoint — including snapshot-on-demand persistence durability
# across a fresh DB session — lives in test_org_valuation_endpoint_172.py.
